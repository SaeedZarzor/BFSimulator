...
# set scalar coloring
ColorBy(output_3_Display, ('POINTS', 'source_terms', 'Magnitude'))
...
# set scalar coloring
ColorBy(output_3_Display, ('POINTS', 'source_terms', 'X'))

# rescale color and/or opacity maps used to exactly fit the current data range
output_3_Display.RescaleTransferFunctionToDataRange(False, False)

# Update a scalar bar component title.
UpdateScalarBarsComponentTitle(source_termsLUT, output_3_Display)

# Rescale transfer function
source_termsLUT.RescaleTransferFunction(0.0, 100.0)

# Rescale transfer function
source_termsPWF.RescaleTransferFunction(0.0, 100.0)
...
# set scalar coloring
ColorBy(output_3_Display, ('POINTS', 'source_terms', 'Y'))
