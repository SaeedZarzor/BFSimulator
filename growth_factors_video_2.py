...
# set scalar coloring
ColorBy(output_3_Display, ('POINTS', 'growth_factor', 'Magnitude'))
...
# set scalar coloring
ColorBy(output_3_Display, ('POINTS', 'growth_factor', 'X'))

# rescale color and/or opacity maps used to exactly fit the current data range
output_3_Display.RescaleTransferFunctionToDataRange(False, False)

# Update a scalar bar component title.
UpdateScalarBarsComponentTitle(growth_factorLUT, output_3_Display)
...
# set scalar coloring
ColorBy(output_3_Display, ('POINTS', 'growth_factor', 'Y'))
